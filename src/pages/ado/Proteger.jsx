...
export default function Proteger() {
  ...
  return (
    <>
      ...
      <h1>{t('Agir sans tout aggraver')}</h1>
      <p className="lead">
      ...
      <LinkCard to="/ado/proteger/desescalade" icon="wind" title="Garder la tête froide" desc="Les réflexes qui protègent." priority="Devrait" />
