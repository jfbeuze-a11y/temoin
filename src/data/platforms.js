...
const fr = [
  {
    ...
    rappel: 'Pense à capturer la preuve AVANT de bloquer : une fois bloqué, tu peux perdre l’accès au contenu.'
  },
  {
    ...
    rappel: 'Capture la vidéo et l’URL avant de signaler : elle peut disparaître ensuite.'
  },
  {
    ...
    rappel: 'Les contenus sont éphémères : la capture rapide est essentielle, mais l’expéditeur peut être averti.'
  },
  {
    ...
    rappel: 'Copie le lien du message et capture la conversation avant de quitter le serveur.'
  },
  {
    ...
    rappel: 'Exporte ou capture la conversation avant de quitter le groupe ou de bloquer.'
  },
  {
    ...
    rappel: 'Note l’URL exacte (avec l’horodatage si commentaire) avant de signaler.'
  }
]
...
const es = [
  {
    ...
    rappel: 'Captura la prueba ANTES de bloquear: una vez bloqueado, puedes perder el acceso al contenido.'
  },
  {
    id: 'tiktok', nom: 'TikTok', couleur: '#000000',
    ...
    rappel: 'Captura el vídeo y la URL antes de denunciar: después puede desaparecer.'
  },
  {
    id: 'snapchat', nom: 'Snapchat', couleur: '#FFFC00',
    ...
    rappel: 'Los contenidos son efímeros: capturar rápido es clave, pero pueden avisar al remitente.'
  },
  {
    id: 'discord', nom: 'Discord', couleur: '#5865F2',
    ...
    rappel: 'Copia el enlace del mensaje y captura la conversación antes de salir del servidor.'
  },
  {
    id: 'whatsapp', nom: 'WhatsApp', couleur: '#25D366',
    ...
    rappel: 'Exporta o captura la conversación antes de salir del grupo o de bloquear.'
  },
  {
    id: 'youtube', nom: 'YouTube', couleur: '#FF0000',
    ...
    rappel: 'Anota la URL exacta (con la marca de tiempo si es un comentario) antes de denunciar.'
  }
]
